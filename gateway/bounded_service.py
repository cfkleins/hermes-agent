...
class BoundedService:
    ...
    def __init__(self, registry, session_db, run_store):
    ...
    try:
        ...
        with ExitStack() as resources:
            ...
            if args.check:
                ...
                service = BoundedService(registry, session_db, run_store)
                asyncio.run(serve(service, args.port))
        return 0
